    ...
    <div className="min-h-screen pt-32 pb-24 px-6">
      ...
      >
        ...
        <div className="prose prose-invert prose-lg max-w-none">
          <p>
            At Appcado Group, we take your privacy seriously. This Privacy Policy explains how we collect, use,
          ...
          <h3>4. Contact Us</h3>
          <p>
            If you have questions or comments about this policy, you may email us at privacy@appcadogroupsolutions.com.
          </p>
        </div>
      </motion.div>
    </div>
